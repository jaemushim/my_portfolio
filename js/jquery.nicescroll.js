...
(function (factory) {
    ...
    var NiceScrollClass = function (myopt, me) {
        ...
        if (opt.rtlmode == 'auto') {
            ...
            if (writingMode == 'horizontal-tb' || writingMode == 'lr-tb' || writingMode === '') {
                ...
                this.isrtlmode =
                    ...
                    writingMode == 'rl-tb';
                this.isvertical =
                    writingMode == 'vertical-rl' || writingMode == 'tb' || writingMode == 'tb-rl';
            }
        } else {
        ...
        this.updateScrollBar = function (len) {
            ...
            if (self.ishwscroll) {
                ...
                if (self.railh)
                    self.railh.css({
                        width:
                            self.win.innerWidth() - (opt.railpadding.left + opt.railpadding.right),
                    });
            } else {
        ...
        this.onResize = function (e, page) {
            ...
            self.scrollvaluemax =
                self.view.h - self.cursorheight - (opt.railpadding.top + opt.railpadding.bottom);
        ...
        this._bind = function (el, name, fn, bubble, active) {
            ...
            passiveSupported &&
            (active || el == window.document || el == window.document.body || el == window)
        ...
        function execScrollWheel(e, hr, chkscroll) {
            ...
            if (hr && opt.oneaxismousemode && px === 0 && py) {
                ...
                if (chkscroll) {
                    var hrend =
                        px < 0 ? self.getScrollLeft() >= self.page.maxw : self.getScrollLeft() <= 0;
                    if (hrend) {
